...
title: WACPAC 概要説明
date: 2025-03-21
description: WACPAC の活動内容・競プロ・Kaggle・CTF・サークル規則などの詳細です。
---
...
![バーチャルコンテスト後の解説会の様子](PICS/virtual-contest-debrief.jpg)
...
執筆時に開催中のコンペ：
![Kaggle のコンペ一覧（当時のスクリーンショット）](PICS/kaggle-competitions.png)
